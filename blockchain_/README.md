This project is an application designed to send encrypted data to a blockchain, and also decrypts the data after retrieve data from the blockchain. Follow the instructions below to run the application.
